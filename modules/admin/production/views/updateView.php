...
<div class="content-main">
    ...
    <form action="index?ctr=save_update_product" enctype="multipart/form-data" class="container" method="POST">
        <div class="form-group">
            ...
            <input type="text" name="productName" class="form-control" placeholder="Enter Name" id="name" value="<?php /* echo $data_update_productions['title'] */  ?>">
        </div>
        <div class="form-group">
            <label for="price">Giá Product:</label>
            <input type="text" name="productPrice" class="form-control" placeholder="Enter price" id="price" value="<?php  ?>">
        </div>
        <div class="form-group">
            <label for="title">Mô tả Product:</label>
            <input type="text" name="productDescripton" class="form-control" placeholder="Enter title" id="title" value="<?php  ?>">
        </div>
        <div class="form-group">
